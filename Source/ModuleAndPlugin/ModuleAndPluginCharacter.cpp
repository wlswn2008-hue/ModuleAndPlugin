...
void AModuleAndPluginCharacter::SpawnTestModuleActor()
{
	...
	ATestActor* SpawnedActor = World->SpawnActor<ATestActor>(ATestActor::StaticClass(), SpawnLocation, SpawnRotation);

	if (SpawnedActor && GEngine)
	{
		GEngine->AddOnScreenDebugMessage(-1, 5.0f, FColor::Cyan,
			TEXT("Character -> TestActor 스폰 성공!"));
	}
}